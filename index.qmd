...
# 1747 understanding: Lemons -> Scurvy Prevention (correct but incomplete)
...
# Misguided belief: Acid -> Bacteria Killed -> Scurvy Prevention (incorrect model)
pgm = daft.PGM(dpi=150, alternate_style="outer")

pgm.add_node("acid", "Acid\n(or Lime)", 1, 1,
       aspect=2.5, scale=1.0,
       plot_params={
         'facecolor': 'mistyrose',
         'edgecolor': 'firebrick',
         'linewidth': 2,
...
pgm.add_edge("acid", "kills")
pgm.add_edge("kills", "prevent")

# Add a subtle caption / visual hint that this model is the historical mistake
pgm.render()
```
...
# 1928 understanding: Lemons -> Vitamin C -> Scurvy Prevention (complete/correct)
pgm = daft.PGM(dpi=150, alternate_style="outer")
...
pgm.add_node("vitc", "Vitamin C\n(Ascorbic Acid)", 2.75, 1,
       aspect=3, scale=1.1,
       plot_params={
...
# Render the completed/correct model
pgm.render()
```
